...
def prepare_and_save(img_path, subfolder):
    try:
        ...
        img_id = ntpath.basename(img_path).replace(".dcm", "")
        l.error('Error processing the image: {'+img_id+'}')
...
def prepare_data():
    dcm_path = 'C:/Users/RadioscientificOne/Desktop/Baturalp HeadCT annotations/rsna 1500-4500/'
    if not os.path.exists('C:/Users/RadioscientificOne/Desktop/Baturalp HeadCT annotations/rsna 1501-4500/'):
        os.makedirs('C:/Users/RadioscientificOne/Desktop/Baturalp HeadCT annotations/rsna 1501-4500/')

    prepare_images_njobs(glob(dcm_path + '/*'), 'C:/Users/RadioscientificOne/Desktop/Baturalp HeadCT annotations/rsna 1501-4500/')
prepare_data()
